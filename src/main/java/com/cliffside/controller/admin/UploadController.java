...
import com.cliffside.config.Constants;
import com.cliffside.util.MyBlogUtils;
...
public class UploadController {
    ...
    public Result upload(HttpServletRequest httpServletRequest, @RequestParam("file") MultipartFile file) throws URISyntaxException {
        ...
        System.out.println(Constants.FILE_UPLOAD_DIC + newFileName);
        try {
        ...
        System.out.println(httpServletRequest.getRequestURL() + "" + "/upload/" + newFileName);
        return result;
    }
